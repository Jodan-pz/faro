...
namespace FARO.Common {
    public interface IWriterEngine {
        ...
        WriterStreamInfo WriteAllToStream(IWriter writer, IImageOutput imageOutput, WriterStream stream, IDataResourceService dataResource, IDictionary<string, object> args = null);
    }
}
