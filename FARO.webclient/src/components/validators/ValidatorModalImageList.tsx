...
interface ValidatorModalImageListProps {
    onSelectImage?: (image: { id: string, name: string }) => void;
    onCloseModal?: () => void;
}


const conn = appConnector<ValidatorModalImageListProps>()(
    (s, p) => ({
...
class ValidatorModalImageListComp extends conn.StatefulCompo<{ image: DropImage, selected: boolean }> {
...
export const ValidatorModalImageList = conn.connect(ValidatorModalImageListComp);